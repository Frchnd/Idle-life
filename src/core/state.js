...
function createInitialState(){
  return {
    ...
    time:{totalHours:0},
    economy:{lastLivingCostAt:0,livingCost:600000,baseLivingCost:600000,housingCost:600000,lifestyleCost:0,transportCost:0,familyCost:0,partnerContribution:0},
    ...
    family:{intent:'undecided',discussionAt:-9999,deferredUntil:-9999,prepared:false,preparedAt:null,stage:'none',planStartedAt:null,arrivalAt:null,arrivalPending:false,arrivalEventSeen:false,children:[],parentingStyle:'shared',lastMilestoneAt:-9999,lastProcessedAt:0,totalSpent:0,lastPrepareAt:-9999,parenting:{stage:null,stageEventPending:null,lastStageEvent:null,familyTimeCount:0,lastFamilyTimeAt:-9999,lastProcessedAt:0,sleepDebt:0,careRhythm:60,development:{curiosity:0,warmth:0,independence:0},dominantTrait:null,milestones:[]},careerCare:{careMode:'shared',careSetAt:-9999,lastCareChangeAt:-9999,careDiscussionSeen:false,careSetupPaid:{shared:true,network:false,daycare:false},lastTensionAt:-9999,nextTensionTurn:'partner',playerBusyUntil:-9999,partnerBusyUntil:-9999,partnerReducedUntil:-9999,playerCareerBoost:0,playerCareerWins:0,partnerCareerWins:0,playerConcessions:0,partnerConcessions:0,paidBackupUses:0,lastCareerChoiceAt:-9999,totalCareSpent:0},schooling:{stage:'not_started',schoolId:null,enrolledAt:null,choiceReady:false,choiceReadyAt:null,supportMode:null,supportReady:false,supportReadyAt:null,lastSupportChangeAt:-9999,lastProcessedAt:0,attendanceRhythm:62,adaptation:50,schoolDays:0,schoolYears:0,parentApproach:null,parentApproachReady:false,parentApproachReadyAt:null,yearMilestonePending:false,lastYearMilestone:0,historyCount:0,migrationGraceUntil:null},adolescence:{stage:'not_started',stageEventPending:null,lastStageEvent:null,lastProcessedAt:0,autonomy:24,parentBond:62,tension:0,peerCircle:null,peerFormedAt:null,peerEventReady:false,peerEventCount:0,nextPeerEventAt:null,activityId:null,activitySupport:null,activityReady:false,activityReadyAt:null,independentCommute:false,commuteMode:'family',commuteReady:false,commuteReadyAt:null,secondaryPreference:null,secondaryPath:null,secondaryReady:false,secondaryReadyAt:null,decisionCount:0,lastDecisionAt:-9999,migrationGraceUntil:null},legacy:{schema:1,children:{},familyMilestones:[],successorId:'nara',lastProcessedAt:0}},
