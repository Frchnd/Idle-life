...
function createInitialState(){
  return {
    ...
    family:{intent:'undecided',discussionAt:-9999,deferredUntil:-9999,prepared:false,preparedAt:null,stage:'none',planStartedAt:null,arrivalAt:null,arrivalPending:false,arrivalEventSeen:false,children:[],parentingStyle:'shared',lastMilestoneAt:-9999,lastProcessedAt:0,totalSpent:0,lastPrepareAt:-9999,parenting:{stage:null,stageEventPending:null,lastStageEvent:null,familyTimeCount:0,lastFamilyTimeAt:-9999,lastProcessedAt:0,sleepDebt:0,careRhythm:60,development:{curiosity:0,warmth:0,independence:0},dominantTrait:null,milestones:[]},careerCare:{careMode:'shared',careSetAt:-9999,lastCareChangeAt:-9999,careDiscussionSeen:false,careSetupPaid:{shared:true,network:false,daycare:false},lastTensionAt:-9999,nextTensionTurn:'partner',playerBusyUntil:-9999,partnerBusyUntil:-9999,partnerReducedUntil:-9999,playerCareerBoost:0,playerCareerWins:0,partnerCareerWins:0,playerConcessions:0,partnerConcessions:0,paidBackupUses:0,lastCareerChoiceAt:-9999,totalCareSpent:0}},
