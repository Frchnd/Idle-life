registerContent('activities',[
  {
    id:'job_search',name:'Cari Kerja',duration:6,hint:'6j · cari peluang kerja',
    requirements:[{path:'player.job',op:'eq',value:null}],
    effects:[
      {type:'hours',value:6},{type:'fatigue',value:8},{type:'path_increment',path:'career.jobSearchCount',value:1}
    ],
    result:'Kamu menghabiskan waktu mencari lowongan dan bertanya ke beberapa tempat.'
  },
  {
    id:'family',name:'Bantu Keluarga',duration:4,hint:'4j · jaga hubungan',
  ...
  {
    id:'rian',name:'Main dengan Rian',duration:3,hint:'3j · sosial',
  ...
  {
    id:'career_search',name:'Cari Peluang Lain',duration:4,hint:'4j · lihat arah karier lain',
    requirements:[{path:'player.job',op:'neq',value:null},{path:'career.workCount',op:'gte',value:4}],
...
registerContent('opportunities',[
  {
    ...
    requirements:[{path:'player.money',op:'gte',value:300000},{status:'utang_keluarga'}],
  ...
  },
  {
    ...
    requirements:[{path:'player.money',op:'gte',value:300000},{status:'utang_rian'}],
...
registerContent('events',[
  {
    id:'exhausted',name:'Sudah Terlalu Dipaksakan',type:'KONDISI',priority:100,
    ...
    requirements:[{path:'player.fatigue',op:'gte',value:70},{flag:'exhaustedWarningSeen',value:false}],
    choices:[
  ...
  },
  {
    ...
    requirements:[{path:'career.jobSearchCount',op:'gte',value:1},{flag:'workshopOfferSeen',value:false}],
    choices:[
  ...
  {
    id:'store_lead',name:'Lowongan Lain Muncul',type:'PELUANG KERJA',priority:70,
    ...
    requirements:[{path:'player.job',op:'eq',value:null},{path:'career.jobSearchCount',op:'gte',value:2},{flag:'workshopOfferSeen',value:true},{flag:'storeOfferSeen',value:false}],
    choices:[
  ...
  {
    id:'first_workshop',name:'Hari Pertama di Bengkel',type:'HARI PERTAMA',priority:60,
    title:'Hari Pertama di Bengkel',text:'Pak Arman memasangkanmu dengan Dika. Bengkel lebih sibuk dari yang terlihat dari luar.',
    requirements:[{path:'player.job',op:'eq',value:'mechanic_junior'},{path:'career.jobWorkCounts.mechanic_junior',op:'gte',value:1},{flag:'firstWorkshopDay',value:false}],
    choices:[
  ...
  {
    id:'first_store',name:'Hari Pertama di Toko',type:'HARI PERTAMA',priority:60,
    ...
    requirements:[{path:'player.job',op:'eq',value:'store_clerk'},{path:'career.jobWorkCounts.store_clerk',op:'gte',value:1},{flag:'firstStoreDay',value:false}],
    choices:[
