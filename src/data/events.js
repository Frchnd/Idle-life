...
function refreshEvent(state){
  ...
  else next=(typeof getNextLifePhaseEvent==='function'?getNextLifePhaseEvent(state):null)||(typeof getNextSharedLifeEvent==='function'?getNextSharedLifeEvent(state):null)||(typeof getNextFamilyEvent==='function'?getNextFamilyEvent(state):null)||(typeof getNextPartnershipEvent==='function'?getNextPartnershipEvent(state):null)||getNextRelationshipStakeEvent(state)||(typeof getNextHealthEvent==='function'?getNextHealthEvent(state):null)||getNextCharacterStoryEvent(state)||getNextEvent(state);
  if(next){
